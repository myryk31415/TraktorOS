...
class CocoDetectionDataset(torch.utils.data.Dataset):
    ...
    def __init__(self, annotation_file: str | Path, image_root: str | Path, is_local: bool):
        ...
        if is_local:
            ...
            self.image_root = annotation_file.split(".")[0].replace("annotation", "data").rpartition('_')[0]
    ...
    def __getitem__(self, index: int) -> tuple[torch.Tensor, dict[str, Any]]:
        ...
        if self.is_local:
            ...
            key = self.image_root + "/" + image_info["file_name"]
            image = self._load_image_from_s3(key)
    ...
    def _load_image_from_s3(self, object_key: str):
        s3 = boto3.client("s3")
